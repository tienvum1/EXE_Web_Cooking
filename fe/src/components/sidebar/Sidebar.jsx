...
export const getWalletBalance = async () => {
  const res = await axios.get(
    `https://exe-web-cooking.onrender.com/api/payment/balance`,
...
const Sidebar = () => {
  ...
  useEffect(() => {
    const fetchPublishedCount = async () => {
      try {
        const res = await axios.get(`https://exe-web-cooking.onrender.com/api/recipes/me/published-recipes`, { withCredentials: true });
  ...
  useEffect(() => {
    const fetchDraftCount = async () => {
      try {
        const res = await axios.get(`https://exe-web-cooking.onrender.com/api/recipes/me/draft-recipes`, { withCredentials: true });
  ...
  useEffect(() => {
    const fetchPendingCount = async () => {
      try {
        const res = await axios.get(`https://exe-web-cooking.onrender.com/api/recipes/me/pendings`, { withCredentials: true });
