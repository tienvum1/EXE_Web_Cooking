...
export const getTransactionHistory = async () => {
    try {
        ...
        throw new Error(error.response?.data?.message || 'Có lỗi xảy ra khi lấy lịch sử giao dịch');
    }
};

// Tạo giao dịch nạp tiền mới
export const createTopupTransaction = async (amount, transferContent, bankInfo) => {
    try {
